  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        ...
        // It is done using decoration, box decoration
        ...
        child: SafeArea(
          child: Column(
            ...
            children: <Widget>[
              ...
              Expanded(
                ...
                child: TextButton(
                  ...
                  onPressed: () {
                    ...
                    this._storyBrain.nextStory(1);
                    setState(() {});
                  },
                  child: Text(
                    //: Step 13 - Use the storyBrain to get the text for choice 1.
                    this._storyBrain.getChoice1(),
              ...
              Expanded(
                flex: 2,
                //: Step 26 - Use a Flutter Visibility Widget to wrap this FlatButton. NO NEED
                ...
                child: Visibility(
                  child: TextButton(
                    ...
                    onPressed: () {
                      ...
                      this._storyBrain.nextStory(2);
                      setState(() {});
                    },
                    child: Text(
                      // Step 14 - Use the storyBrain to get the text for choice 2.
                      this._storyBrain.getChoice2(),
                      style: TextStyle(fontSize: 20.0, color: Colors.black),
                    ),
                  ),
                ),
